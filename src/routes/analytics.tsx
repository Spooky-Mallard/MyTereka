...
import { categoryMeta, formatCurrency, transactions } from "@/lib/mock-data";
...
export const Route = createFileRoute("/analytics")({
  head: () => ({
    meta: [
      { title: "Analytics — FinWise" },
      { name: "description", content: "Visual breakdown of your income, expenses, and spending trends." },
    ],
  }),
