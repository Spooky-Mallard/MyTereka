...
function GoalsPage() {
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      ...
      >
        <div>
          <div className="text-xs font-medium" style={{ color: "var(--muted-foreground)" }}>Total saved</div>
        ...
        />
        <div>
          <div className="text-xs font-medium" style={{ color: "var(--muted-foreground)" }}>Total target</div>
        ...
        />
        <div>
          <div className="text-xs font-medium" style={{ color: "var(--muted-foreground)" }}>Overall progress</div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {goals.map((g) => {
          ...
          return (
            <div
              key={g.id}
              className="rounded-2xl p-6 transition cursor-pointer hover:shadow-finwise-md"
              style={{ background: "var(--card)", boxShadow: "var(--shadow-card)" }}
            >
              {/* Top row */}
