    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        >
          ...
          />
          <div
            className="pointer-events-none absolute -bottom-8 left-1/3 h-40 w-40 rounded-full"
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="mt-1 text-xl font-semibold">
                  {hideBalance ? "••••" : formatCurrency(balance.income)}
                </div>
              </div>
              <div
                className="rounded-xl p-4"
              ...
              >
                ...
                <div className="mt-1 text-xl font-semibold">
                  {hideBalance ? "••••" : formatCurrency(balance.expense)}
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          {[
            ...
            <button
              key={label}
              className="flex items-center gap-3 rounded-xl p-3 text-left transition hover:opacity-80 active:scale-95"
              ...
              return (
                ...
                >
                  <span
                    ...
                    style={{
                      background: meta?.tint ? `color-mix(in srgb, ${meta.tint} 15%, transparent)` : "var(--surface-alt)",
